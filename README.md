...
For example this `docker-compose.custom.yml` tells Net Test to test `example.com` before any others, and run the ping test every second (see [Command Line Options](#command-line-options)):
